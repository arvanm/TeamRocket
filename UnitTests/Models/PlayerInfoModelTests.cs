...
namespace UnitTests.Models
{
    ...
    public class PlayerInfoModelTests
    {
        ...
        [Test]
        public void PlayerInfoModel_Constructor_Character_DojoMaster_Default_Should_Pass()
        {
            // Arrange
        ...
        [Test]
        public void PlayerInfoModel_Constructor_Character_PetLover_Default_Should_Pass()
        {
            // Arrange
        ...
        [Test]
        public void PlayerInfoModel_Constructor_Character_QuickAttacker_Default_Should_Pass()
        {
            // Arrange
        ...
        {
            // Arrange
            var data = new PlayerInfoModel(new CharacterModel { Job = CharacterJobEnum.PetLover });
        ...
        [Test]
        public void PlayerInfoModel_SelectHealingAbility_PetLover_Heal_Avaiable_Should_Pass()
        {
            // Arrange
            var data = new PlayerInfoModel(new CharacterModel { Job = CharacterJobEnum.PetLover });
        ...
        [Test]
        public void PlayerInfoModel_SelectHealingAbility_PetLover_Heal_Not_Needed_Should_Pass()
        {
            // Arrange
            var data = new PlayerInfoModel(new CharacterModel { Job = CharacterJobEnum.PetLover });
            data.AbilityTracker[AbilityEnum.Heal] = 1;
        ...
        [Test]
        public void PlayerInfoModel_SelectHealingAbility_PetLover_Heal_Not_Available_Should_Return_Unknown()
        {
            // Arrange
            var data = new PlayerInfoModel(new CharacterModel { Job = CharacterJobEnum.PetLover });
            data.AbilityTracker[AbilityEnum.Heal] = 0;
        ...
        [Test]
        public void PlayerInfoModel_SelectHealingAbility_DojoMaster_Bandage_Avaiable_Should_Pass()
        {
            // Arrange
            var data = new PlayerInfoModel(new CharacterModel { Job = CharacterJobEnum.DojoMaster });
        ...
        [Test]
        public void PlayerInfoModel_SelectAbilityToUse_DojoMaster_Avaiable_Should_Pass()
        {
            // Arrange
            var data = new PlayerInfoModel(new CharacterModel { Job = CharacterJobEnum.DojoMaster });
        ...
        [Test]
        public void PlayerInfoModel_SelectAbilityToUse_PetLover_Avaiable_Should_Pass()
        {
            // Arrange
            var data = new PlayerInfoModel(new CharacterModel { Job = CharacterJobEnum.PetLover });
        ...
        [Test]
        public void PlayerInfoModel_SelectAbilityToUse_PetLover_Heal_Should_Skip()
        {
            // Arrange
            var data = new PlayerInfoModel(new CharacterModel { Job = CharacterJobEnum.PetLover });
