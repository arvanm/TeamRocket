...
{ 
    // This converter is changing ItemLocationEnum to a boolean representing whether it has damage
    ...
    public class ItemLocationToDamageBoolConverterHelper : IValueConverter
    {
        ...
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            if (value is Enum)
            {
                return ((ItemLocationEnum)value == ItemLocationEnum.PrimaryHand || (ItemLocationEnum)value == ItemLocationEnum.Pokeball);
            }
